...
class EditUserForm(BaseForm):
    def __init__(self, controller, parent):
        ...
        self._users_list = self._controller.get_names()

        label = ctk.CTkLabel(self, text="Edit User", font=("Arial", 16))
        label.grid(row=0, column=0, columnspan=3, pady=10, sticky='ew')

        ctk.CTkLabel(self, text="Użytkownik:").grid(row=8, column=0, sticky="w", padx=(20, 5), pady=5)
        self.dropdown_ou = ctk.CTkOptionMenu(self, values=self._users_list)
