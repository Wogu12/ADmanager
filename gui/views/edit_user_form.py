...
class EditUserForm(BaseForm):
    def __init__(self, controller, parent):
        ...
        label = ctk.CTkLabel(self, text="Edit User", font=("Arial", 16))
        label.grid(row=0, column=0, columnspan=3, pady=10, sticky='ew')

        ctk.CTkLabel(self, text="Użytkownik:").grid(row=1, column=0, sticky="w", padx=(20, 5), pady=5)
        ...
        self.add_group_btn.grid(row=1, column=2, sticky='ew', pady=15, padx=10)
    ...
    def _show_user_data(self):
        ...
        ctk.CTkLabel(self, text="Imię:").grid(row=2, column=0, sticky="w", padx=(20, 5), pady=5)
        _entry_name_value = tk.StringVar(value=_data.get('name'))
        self.entry_name = ctk.CTkEntry(self, textvariable=_entry_name_value)
        self.entry_name.grid(row=2, column=1, columnspan=3, sticky="ew", padx=(5, 10), pady=5)

        ctk.CTkLabel(self, text="Nazwisko:").grid(row=3, column=0, sticky="w", padx=(20, 5), pady=5)
        _entry_surname_value = tk.StringVar(value=_data.get('surname'))
        self.entry_surname = ctk.CTkEntry(self, textvariable=_entry_surname_value)
        self.entry_surname.grid(row=3, column=1, columnspan=3, sticky="ew", padx=(5, 10), pady=5)

        ctk.CTkLabel(self, text="Stanowisko:").grid(row=4, column=0, sticky="w", padx=(20, 5), pady=5)
        _entry_job_title_value = tk.StringVar(value=_data.get('job_title'))
        self.entry_job_title = ctk.CTkEntry(self, textvariable=_entry_job_title_value)
        self.entry_job_title.grid(row=4, column=1, columnspan=3, sticky="ew", padx=(5, 10), pady=5)

        ctk.CTkLabel(self, text="E-mail:").grid(row=5, column=0, sticky="w", padx=(20, 5), pady=5)
        _entry_mail_value = tk.StringVar(value=_data.get('mail'))
        self.entry_mail = ctk.CTkEntry(self, textvariable=_entry_mail_value)
        self.entry_mail.grid(row=5, column=1, columnspan=3, sticky="ew", padx=(5, 10), pady=5)

        ctk.CTkLabel(self, text="Login:").grid(row=6, column=0, sticky="w", padx=(20, 5), pady=5)
        self.entry_login = ctk.CTkEntry(self)
        self.entry_login.grid(row=6, column=1, columnspan=3, sticky="ew", padx=(5, 10), pady=5)
